...
<div id="contenedor">
	...
	<div id="izquierda" class="galeria">
		...
		<div class="imagen">
			...
			<img style="position:relative; left: 2px;" src="images/propiedades/<?=$propiedades->foto8?>" class="thumbs " />
			<?php endif; ?>
			<?php if(!empty($propiedades->foto9) || $propiedades->foto9 != ""): ?>
			<img style="position:relative; left: 4px;"src="images/propiedades/<?=$propiedades->foto9?>" class="thumbs last" />
			<?php endif; ?>
