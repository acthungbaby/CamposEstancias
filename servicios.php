...
<div id="contenedor">
	<a name="servicios"></a>
	<h1>Servicios</h1>
        <div id="izquierda" style="position: relative; left:300px;">
	<p>Asesoramiento de compra y venta de propiedades</p>
        <p>Tasaciones</p>
        <p>Desarrollo y administración de establecimientos pecuarios</p>
        <p>Análisis de suelos</p>
        <p>Gestión de estudios de impacto ambiental</p>
        <p>Proyección e implementación de proyectos de forestación y reforestación</p>
        <p>Proyección de ganadería y agricultura.</p>
        <p>Gestoría de documentos legales (due diligent)</p>
        <p>Geo referenciamiento</p>
        </div>
</div>
