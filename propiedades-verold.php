...
<div id="contenedor">
	...
	<div id="derecha" class="propiedades">
		<div class="izquierda">
			...
			<p><strong>Superficie:</strong> <?=$propiedades->superficie?> <?php if($propiedades->unidad_medida == 0): echo "Has"; else: echo "m2"; endif;?></p>
			<p><strong>Precio Un.:</strong> <?=$propiedades->precio_un?> <?php if($propiedades->moneda == "1"): echo "Gs."; else: echo "USD."; endif;?> p/ <?php if($propiedades->unidad_medida == 0): echo "Ha"; else: echo "m2"; endif;?></p>
			<p><strong>Precio:</strong> <?=$propiedades->precio?>  <?php if($propiedades->moneda == "1"): echo "Gs."; else: echo "USD."; endif;?></p>
		...
		<form action="propiedades-ver.php?id=<?=$_GET['id']?>" method="post">
		<input type="hidden" id="alf_num" name="alf_num" value="<?php echo $propiedades->ref_alf.$propiedades->ref_num; ?>" /></p>
		<p>Nombre <a>*</a><br />
		<input type="text" id="nombre" name="nombre" class="txt" /></p>
		<p>E-mail <a>*</a><br />
		<input type="text" id="email" name="email" class="txt" /></p>
		<p>Teléfono <a>*</a><br />
		<input type="text" id="telefono" name="telefono" class="txt" /></p>
		<p>Consulta <a>*</a><br />
